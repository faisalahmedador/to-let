...
const Signup = () => {
    ...
    useEffect(() => {
        if (success) {
            saveUserIdentity(success.response.token, success.response.data.id);
            history.push('/');
        }
    }, [history, success])
            ...
            <section className="signup-form">
                <div className="form-info">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input className="btn border-1-primary button-default-style d-block w-100 my-2" type="submit"
                               value="Sign Up"/>
                    </form>
